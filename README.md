...
> Der Import-Badge verweist auf den `main`-Branch. Falls dein Standard-Branch anders heißt (aktuell z. B. `claude/homeassistant-blueprint-install-phycpv`), passe die `blueprint_url` im Badge-Link entsprechend an.
